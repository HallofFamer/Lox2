...
LOX_METHOD(DateTime, diff) {
    ...
    ASSERT_ARG_INSTANCE_OF("DateTime::diff(dateTime)", 0, clox.std.util.Date);
    ObjClass* dateTimeClass = getNativeClass(vm, "clox.std.util.DateTime");
    ObjInstance* dateTime = AS_INSTANCE(args[0]);

    double timestamp = dateTimeObjGetTimestamp(vm, AS_INSTANCE(receiver));
    double timestamp2 = (dateTime->obj.klass == dateTimeClass) ? dateTimeObjGetTimestamp(vm, dateTime) : dateObjGetTimestamp(vm, dateTime);
    RETURN_NUMBER(timestamp - timestamp2);
}
...
void registerUtilPackage(VM* vm) {
    ...
    DEF_INTERCEPTOR(dateClass, Date, INTERCEPTOR_INIT, __init__, 3, NATIVE_TYPE(clox.std.util.Date), NATIVE_TYPE(Int), NATIVE_TYPE(Int), NATIVE_TYPE(Int));
    DEF_METHOD(dateClass, Date, compareTo, 1, NATIVE_TYPE(Int), NATIVE_TYPE(TComparable));
    DEF_METHOD(dateClass, Date, diff, 1, NATIVE_TYPE(Number), NATIVE_TYPE(clox.std.util.Date));
    DEF_METHOD(dateClass, Date, getTimestamp, 0, NATIVE_TYPE(Number));
    DEF_METHOD(dateClass, Date, toDateTime, 0, NATIVE_TYPE(clox.std.util.DateTime));
    DEF_METHOD(dateClass, Date, toString, 0, NATIVE_TYPE(String));
    DEF_OPERATOR(dateClass, Date, ==, __equal__, 1, NATIVE_TYPE(Bool), NATIVE_TYPE(Object));
    DEF_OPERATOR(dateClass, Date, >, __greater__, 1, NATIVE_TYPE(Bool), NATIVE_TYPE(TComparable));
    DEF_OPERATOR(dateClass, Date, <, __less__, 1, NATIVE_TYPE(Bool), NATIVE_TYPE(TComparable));
    DEF_OPERATOR(dateClass, Date, +, __add__, 1, NATIVE_TYPE(clox.std.util.Date), NATIVE_TYPE(clox.std.util.Duration));
    DEF_OPERATOR(dateClass, Date, -, __subtract__, 1, NATIVE_TYPE(clox.std.util.Date), NATIVE_TYPE(clox.std.util.Duration));
    ...
    DEF_METHOD(dateMetaclass, DateClass, fromTimestamp, 1, NATIVE_TYPE(clox.std.util.Date), NATIVE_TYPE(Number));
    DEF_METHOD(dateMetaclass, DateClass, parse, 1, NATIVE_TYPE(clox.std.util.Date), NATIVE_TYPE(String));
    ...
    DEF_INTERCEPTOR(dateTimeClass, DateTime, INTERCEPTOR_INIT, __init__, 6, NATIVE_TYPE(clox.std.util.DateTime), NATIVE_TYPE(Int), NATIVE_TYPE(Int), NATIVE_TYPE(Int), NATIVE_TYPE(Int), NATIVE_TYPE(Int), NATIVE_TYPE(Int));
    DEF_METHOD(dateTimeClass, DateTime, compareTo, 1, NATIVE_TYPE(Int), NATIVE_TYPE(TComparable));
    DEF_METHOD(dateTimeClass, DateTime, diff, 1, NATIVE_TYPE(Number), NATIVE_TYPE(clox.std.util.Date));
    DEF_METHOD(dateTimeClass, DateTime, getTimestamp, 0, NATIVE_TYPE(Number));
    DEF_METHOD(dateTimeClass, DateTime, toDate, 0, NATIVE_TYPE(clox.std.util.Date));
    DEF_METHOD(dateTimeClass, DateTime, toString, 0, NATIVE_TYPE(String));
    DEF_OPERATOR(dateTimeClass, DateTime, ==, __equal__, 1, NATIVE_TYPE(Bool), NATIVE_TYPE(Object));
    DEF_OPERATOR(dateTimeClass, DateTime, >, __greater__, 1, NATIVE_TYPE(Bool), NATIVE_TYPE(TComparable));
    DEF_OPERATOR(dateTimeClass, DateTime, <, __less__, 1, NATIVE_TYPE(Bool), NATIVE_TYPE(TComparable));
    DEF_OPERATOR(dateTimeClass, DateTime, +, __add__, 1, NATIVE_TYPE(clox.std.util.DateTime), NATIVE_TYPE(clox.std.util.Duration));
    DEF_OPERATOR(dateTimeClass, DateTime, -, __subtract__, 1, NATIVE_TYPE(clox.std.util.DateTime), NATIVE_TYPE(clox.std.util.Duration));
    ...
    DEF_METHOD(dateTimeMetaClass, DateTimeClass, fromTimestamp, 1, NATIVE_TYPE(clox.std.util.DateTime), NATIVE_TYPE(Number));
    DEF_METHOD(dateTimeMetaClass, DateTimeClass, parse, 1, NATIVE_TYPE(clox.std.util.DateTime), NATIVE_TYPE(String));
    ...
    DEF_INTERCEPTOR(durationClass, Duration, INTERCEPTOR_INIT, __init__, 4, NATIVE_TYPE(clox.std.util.Duration), NATIVE_TYPE(Int), NATIVE_TYPE(Int), NATIVE_TYPE(Int), NATIVE_TYPE(Int));
    DEF_METHOD(durationClass, Duration, compareTo, 1, NATIVE_TYPE(Int), NATIVE_TYPE(TComparable));
    DEF_METHOD(durationClass, Duration, getTotalSeconds, 0, NATIVE_TYPE(Int));
    DEF_METHOD(durationClass, Duration, toString, 0, NATIVE_TYPE(String));
    DEF_OPERATOR(durationClass, Duration, ==, __equal__, 1, NATIVE_TYPE(Bool), NATIVE_TYPE(Object));
    DEF_OPERATOR(durationClass, Duration, >, __greater__, 1, NATIVE_TYPE(Bool), NATIVE_TYPE(TComparable));
    DEF_OPERATOR(durationClass, Duration, <, __less__, 1, NATIVE_TYPE(Bool), NATIVE_TYPE(TComparable));
    DEF_OPERATOR(durationClass, Duration, +, __add__, 1, NATIVE_TYPE(clox.std.util.Duration), NATIVE_TYPE(clox.std.util.Duration));
    DEF_OPERATOR(durationClass, Duration, -, __subtract__, 1, NATIVE_TYPE(clox.std.util.Duration), NATIVE_TYPE(clox.std.util.Duration));

    ObjClass* durationMetaclass = durationClass->obj.klass;
    DEF_METHOD(durationMetaclass, DurationClass, ofDays, 1, NATIVE_TYPE(clox.std.util.Duration), NATIVE_TYPE(Int));
    DEF_METHOD(durationMetaclass, DurationClass, ofHours, 1, NATIVE_TYPE(clox.std.util.Duration), NATIVE_TYPE(Int));
    DEF_METHOD(durationMetaclass, DurationClass, ofMinutes, 1, NATIVE_TYPE(clox.std.util.Duration), NATIVE_TYPE(Int));
    DEF_METHOD(durationMetaclass, DurationClass, ofSeconds, 1, NATIVE_TYPE(clox.std.util.Duration), NATIVE_TYPE(Int));
    ...
    DEF_INTERCEPTOR(vm->promiseClass, Promise, INTERCEPTOR_INIT, __init__, 1, NATIVE_TYPE(clox.std.util.Promise), PARAM_TYPE_CALLABLE(NATIVE_TYPE(void), 2, NATIVE_TYPE(TCallable), NATIVE_TYPE(TCallable)));
    ...
    DEF_INTERCEPTOR(randomClass, Random, INTERCEPTOR_INIT, __init__, 0, NATIVE_TYPE(clox.std.util.Random));
    DEF_METHOD(randomClass, Random, getSeed, 0, NATIVE_TYPE(Int));
    DEF_METHOD(randomClass, Random, nextBool, 0, NATIVE_TYPE(Bool));
    DEF_METHOD(randomClass, Random, nextFloat, 0, NATIVE_TYPE(Float));
    DEF_METHOD(randomClass, Random, nextInt, 0, NATIVE_TYPE(Int));
    DEF_METHOD(randomClass, Random, nextIntBounded, 1, NATIVE_TYPE(Int), NATIVE_TYPE(Int));
    DEF_METHOD(randomClass, Random, setSeed, 1, NATIVE_TYPE(void), NATIVE_TYPE(Int));

    bindSuperclass(vm, regexClass, vm->objectClass);
    DEF_FIELD(regexClass, pattern, String, false, OBJ_VAL(emptyString(vm)));
    DEF_INTERCEPTOR(regexClass, Regex, INTERCEPTOR_INIT, __init__, 1, NATIVE_TYPE(clox.std.util.Regex), NATIVE_TYPE(String));
    DEF_METHOD(regexClass, Regex, match, 1, NATIVE_TYPE(Bool), NATIVE_TYPE(String));
    DEF_METHOD(regexClass, Regex, replace, 2, NATIVE_TYPE(String), NATIVE_TYPE(String), NATIVE_TYPE(String));
    DEF_METHOD(regexClass, Regex, toString, 0, NATIVE_TYPE(String));
    ...
    DEF_INTERCEPTOR(vm->timerClass, Timer, INTERCEPTOR_INIT, __init__, 3, NATIVE_TYPE(clox.std.util.Timer), NATIVE_TYPE(TCallable), NATIVE_TYPE(Int), NATIVE_TYPE(Int));
    DEF_METHOD(vm->timerClass, Timer, clear, 0, NATIVE_TYPE(void));
    DEF_METHOD(vm->timerClass, Timer, isRunning, 0, NATIVE_TYPE(Bool));
    DEF_METHOD(vm->timerClass, Timer, run, 0, NATIVE_TYPE(clox.std.util.Timer));
    DEF_METHOD(vm->timerClass, Timer, toString, 0, NATIVE_TYPE(String));

    ObjClass* timerMetaclass = vm->timerClass->obj.klass;
    DEF_METHOD(timerMetaclass, TimerClass, interval, 2, NATIVE_TYPE(clox.std.util.Timer), NATIVE_TYPE(TCallable), NATIVE_TYPE(Int));
    DEF_METHOD(timerMetaclass, TimerClass, timeout, 2, NATIVE_TYPE(clox.std.util.Timer), NATIVE_TYPE(TCallable), NATIVE_TYPE(Int));

    bindSuperclass(vm, uuidClass, vm->objectClass);
    DEF_FIELD(uuidClass, buffer, String, false, OBJ_VAL(emptyString(vm)));
    DEF_INTERCEPTOR(uuidClass, UUID, INTERCEPTOR_INIT, __init__, 0, NATIVE_TYPE(clox.std.util.UUID));
    DEF_METHOD(uuidClass, UUID, toString, 0, NATIVE_TYPE(String));
    ...
    DEF_METHOD(uuidMetaclass, UUIDClass, generate, 0, NATIVE_TYPE(String));
    DEF_METHOD(uuidMetaclass, UUIDClass, isUUID, 1, NATIVE_TYPE(Bool), NATIVE_TYPE(String));
    DEF_METHOD(uuidMetaclass, UUIDClass, parse, 1, NATIVE_TYPE(clox.std.util.UUID), NATIVE_TYPE(String));
