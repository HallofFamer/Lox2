...
void registerCollectionPackage(VM* vm) {
    ...
    DEF_METHOD(collectionClass, Collection, add, 1, RETURN_TYPE(clox.std.collection.Collection), PARAM_TYPE(E));
    DEF_METHOD(collectionClass, Collection, addAll, 1, RETURN_TYPE(void), PARAM_TYPE(clox.std.collection.Collection));
    DEF_METHOD(collectionClass, Collection, collect, 1, RETURN_TYPE(clox.std.collection.Collection), PARAM_TYPE_CALLABLE(RETURN_TYPE(E), 1, PARAM_TYPE(E)));
    DEF_METHOD(collectionClass, Collection, detect, 1, RETURN_TYPE(E), PARAM_TYPE_CALLABLE(RETURN_TYPE(Bool), 1, PARAM_TYPE(E)));
    DEF_METHOD(collectionClass, Collection, each, 1, RETURN_TYPE(void), PARAM_TYPE_CALLABLE(RETURN_TYPE(void), 1, PARAM_TYPE(E)));
    ...
    DEF_METHOD(collectionClass, Collection, reject, 1, RETURN_TYPE(clox.std.collection.Collection), PARAM_TYPE_CALLABLE(RETURN_TYPE(Bool), 1, PARAM_TYPE(E)));
    DEF_METHOD(collectionClass, Collection, select, 1, RETURN_TYPE(clox.std.collection.Collection), PARAM_TYPE_CALLABLE(RETURN_TYPE(Bool), 1, PARAM_TYPE(E)));
    ...
    DEF_METHOD(listClass, List, eachIndex, 1, RETURN_TYPE(void), PARAM_TYPE_CALLABLE(RETURN_TYPE(void), 2, PARAM_TYPE(Int), PARAM_TYPE(E)));
    DEF_METHOD(listClass, List, getAt, 1, RETURN_TYPE(E), PARAM_TYPE(Int));
    DEF_METHOD(listClass, List, putAt, 2, RETURN_TYPE(void), PARAM_TYPE(Int), PARAM_TYPE(E));
    ...
    DEF_METHOD(vm->arrayClass, Array, add, 1, RETURN_TYPE(clox.std.collection.Array), PARAM_TYPE(E));
    ...
    DEF_METHOD(vm->arrayClass, Array, collect, 1, RETURN_TYPE(clox.std.collection.Array), PARAM_TYPE_CALLABLE(RETURN_TYPE(E), 1, PARAM_TYPE(E)));
    DEF_METHOD(vm->arrayClass, Array, contains, 1, RETURN_TYPE(Bool), PARAM_TYPE(E));
    DEF_METHOD(vm->arrayClass, Array, detect, 1, RETURN_TYPE(E), PARAM_TYPE_CALLABLE(RETURN_TYPE(Bool), 1, PARAM_TYPE(E)));
    DEF_METHOD(vm->arrayClass, Array, each, 1, RETURN_TYPE(void), PARAM_TYPE_CALLABLE(RETURN_TYPE(void), 1, PARAM_TYPE(E)));
    DEF_METHOD(vm->arrayClass, Array, eachIndex, 1, RETURN_TYPE(void), PARAM_TYPE_CALLABLE(RETURN_TYPE(void), 2, PARAM_TYPE(Int), PARAM_TYPE(E)));
    DEF_METHOD(vm->arrayClass, Array, equals, 1, RETURN_TYPE(Bool), PARAM_TYPE(Object));
    DEF_METHOD(vm->arrayClass, Array, fill, 2, RETURN_TYPE(void), PARAM_TYPE(Int), PARAM_TYPE(E));
    DEF_METHOD(vm->arrayClass, Array, getAt, 1, RETURN_TYPE(E), PARAM_TYPE(Int));
    DEF_METHOD(vm->arrayClass, Array, indexOf, 1, RETURN_TYPE(Int), PARAM_TYPE(E));
    DEF_METHOD(vm->arrayClass, Array, insertAt, 2, RETURN_TYPE(void), PARAM_TYPE(Int), PARAM_TYPE(E));
    ...
    DEF_METHOD(vm->arrayClass, Array, lastIndexOf, 1, RETURN_TYPE(Int), PARAM_TYPE(E));
    DEF_METHOD(vm->arrayClass, Array, length, 0, RETURN_TYPE(Int));
    DEF_METHOD(vm->arrayClass, Array, putAt, 2, RETURN_TYPE(void), PARAM_TYPE(Int), PARAM_TYPE(E));
    DEF_METHOD(vm->arrayClass, Array, reject, 1, RETURN_TYPE(clox.std.collection.Array), PARAM_TYPE_CALLABLE(RETURN_TYPE(Bool), 1, PARAM_TYPE(E)));
    DEF_METHOD(vm->arrayClass, Array, remove, 1, RETURN_TYPE(Bool), PARAM_TYPE(E));
    DEF_METHOD(vm->arrayClass, Array, removeAt, 1, RETURN_TYPE(Bool), PARAM_TYPE(Int));
    DEF_METHOD(vm->arrayClass, Array, select, 1, RETURN_TYPE(clox.std.collection.Array), PARAM_TYPE_CALLABLE(RETURN_TYPE(Bool), 1, PARAM_TYPE(E)));
    ...
    DEF_OPERATOR(vm->arrayClass, Array, [], __getSubscript__, 1, RETURN_TYPE(E), PARAM_TYPE(Int));
    DEF_OPERATOR(vm->arrayClass, Array, []=, __setSubscript__, 2, RETURN_TYPE(void), PARAM_TYPE(Int), PARAM_TYPE(E));
    ...
    DEF_METHOD(linkedListClass, LinkedList, add, 1, RETURN_TYPE(clox.std.collection.LinkedList), PARAM_TYPE(E));
    DEF_METHOD(linkedListClass, LinkedList, addAt, 2, RETURN_TYPE(E), PARAM_TYPE(Int), PARAM_TYPE(E));
    DEF_METHOD(linkedListClass, LinkedList, addFirst, 1, RETURN_TYPE(void), PARAM_TYPE(E));
    DEF_METHOD(linkedListClass, LinkedList, addLast, 1, RETURN_TYPE(void), PARAM_TYPE(E));
    DEF_METHOD(linkedListClass, LinkedList, clear, 0, RETURN_TYPE(void));
    DEF_METHOD(linkedListClass, LinkedList, contains, 1, RETURN_TYPE(Bool), PARAM_TYPE(E));
    DEF_METHOD(linkedListClass, LinkedList, getAt, 1, RETURN_TYPE(E), PARAM_TYPE(Int));
    DEF_METHOD(linkedListClass, LinkedList, getFirst, 0, RETURN_TYPE(E));
    DEF_METHOD(linkedListClass, LinkedList, getLast, 0, RETURN_TYPE(E));
    DEF_METHOD(linkedListClass, LinkedList, indexOf, 1, RETURN_TYPE(Int), PARAM_TYPE(E));
    ...
    DEF_METHOD(linkedListClass, LinkedList, lastIndexOf, 0, RETURN_TYPE(Int), PARAM_TYPE(E));
    DEF_METHOD(linkedListClass, LinkedList, length, 0, RETURN_TYPE(Int));
    DEF_METHOD(linkedListClass, LinkedList, node, 1, RETURN_TYPE(E), PARAM_TYPE(Int));
    DEF_METHOD(linkedListClass, LinkedList, peek, 0, RETURN_TYPE(E));
    DEF_METHOD(linkedListClass, LinkedList, putAt, 2, RETURN_TYPE(void), PARAM_TYPE(Int), PARAM_TYPE(E));
    DEF_METHOD(linkedListClass, LinkedList, remove, 0, RETURN_TYPE(E));
    DEF_METHOD(linkedListClass, LinkedList, removeFirst, 0, RETURN_TYPE(E));
    DEF_METHOD(linkedListClass, LinkedList, removeLast, 0, RETURN_TYPE(E));
    ...
    DEF_INTERCEPTOR(vm->nodeClass, Node, INTERCEPTOR_INIT, __init__, 3, RETURN_TYPE(clox.std.collection.Node), PARAM_TYPE(E), PARAM_TYPE(clox.std.collection.Node), PARAM_TYPE(clox.std.collection.Node));
    DEF_METHOD(vm->nodeClass, Node, clone, 0, RETURN_TYPE(clox.std.collection.Node));
    DEF_METHOD(vm->nodeClass, Node, element, 0, RETURN_TYPE(E));
    ...
    DEF_METHOD(vm->dictionaryClass, Dictionary, getAt, 1, RETURN_TYPE(V), PARAM_TYPE(K));
    ...
    DEF_OPERATOR(vm->dictionaryClass, Dictionary, [], __getSubscript__, 1, RETURN_TYPE(V), PARAM_TYPE(K));
    DEF_OPERATOR(vm->dictionaryClass, Dictionary, []=, __setSubscript__, 2, RETURN_TYPE(void), PARAM_TYPE(K), PARAM_TYPE(V));
    ...
    DEF_INTERCEPTOR(vm->entryClass, Entry, INTERCEPTOR_INIT, __init__, 2, RETURN_TYPE(clox.std.collection.Entry), PARAM_TYPE(K), PARAM_TYPE(V));
    DEF_METHOD(vm->entryClass, Entry, clone, 0, RETURN_TYPE(clox.std.collection.Entry));
    DEF_METHOD(vm->entryClass, Entry, getKey, 0, RETURN_TYPE(K));
    DEF_METHOD(vm->entryClass, Entry, getValue, 0, RETURN_TYPE(V));
    DEF_METHOD(vm->entryClass, Entry, setValue, 1, RETURN_TYPE(void), PARAM_TYPE(K));
    ...
    DEF_METHOD(setClass, Set, add, 1, RETURN_TYPE(Bool), PARAM_TYPE(E));
    DEF_METHOD(setClass, Set, clear, 0, RETURN_TYPE(void));
    DEF_METHOD(setClass, Set, clone, 0, RETURN_TYPE(clox.std.collection.Set));
    DEF_METHOD(setClass, Set, contains, 1, RETURN_TYPE(Bool), PARAM_TYPE(E));
    ...
    DEF_METHOD(setClass, Set, remove, 1, RETURN_TYPE(E), PARAM_TYPE(E));
    ...
    DEF_METHOD(vm->rangeClass, Range, step, 2, RETURN_TYPE(void), PARAM_TYPE(Int), PARAM_TYPE_CALLABLE(RETURN_TYPE(void), 1, PARAM_TYPE(Int)));
    ...
    DEF_METHOD(stackClass, Stack, contains, 1, RETURN_TYPE(Bool), PARAM_TYPE(E));
    DEF_METHOD(stackClass, Stack, getFirst, 0, RETURN_TYPE(E));
    ...
    DEF_METHOD(stackClass, Stack, peek, 0, RETURN_TYPE(E));
    DEF_METHOD(stackClass, Stack, pop, 0, RETURN_TYPE(E));
    DEF_METHOD(stackClass, Stack, push, 1, RETURN_TYPE(void), PARAM_TYPE(E));
    DEF_METHOD(stackClass, Stack, search, 1, RETURN_TYPE(Int), PARAM_TYPE(E));
    ...
    DEF_METHOD(queueClass, Queue, contains, 1, RETURN_TYPE(Bool), PARAM_TYPE(E));
    DEF_METHOD(queueClass, Queue, dequeue, 0, RETURN_TYPE(E));
    DEF_METHOD(queueClass, Queue, enqueue, 1, RETURN_TYPE(void), PARAM_TYPE(E));
    DEF_METHOD(queueClass, Queue, getFirst, 0, RETURN_TYPE(E));
    DEF_METHOD(queueClass, Queue, getLast, 0, RETURN_TYPE(E));
    ...
    DEF_METHOD(queueClass, Queue, peek, 0, RETURN_TYPE(E));
    DEF_METHOD(queueClass, Queue, search, 1, RETURN_TYPE(Bool), PARAM_TYPE(E));
