...
void registerCollectionPackage(VM* vm) {
    ...
    DEF_METHOD(vm->dictionaryClass, Dictionary, collect, 1, RETURN_TYPE(clox.std.collection.Dictionary), PARAM_TYPE_CALLABLE_N(RETURN_TYPE(Object), 2, PARAM_TYPE(Object), PARAM_TYPE(Object)));
    ...
    DEF_METHOD(vm->dictionaryClass, Dictionary, detect, 1, RETURN_TYPE(Object), PARAM_TYPE_CALLABLE_N(RETURN_TYPE(Bool), 2, PARAM_TYPE(Object), PARAM_TYPE(Object)));
    ...
    DEF_METHOD(vm->dictionaryClass, Dictionary, reject, 1, RETURN_TYPE(clox.std.collection.Dictionary), PARAM_TYPE_CALLABLE_N(RETURN_TYPE(Bool), 2, PARAM_TYPE(Object), PARAM_TYPE(Object)));
    DEF_METHOD(vm->dictionaryClass, Dictionary, removeAt, 1, RETURN_TYPE(Object), PARAM_TYPE(Object));
    DEF_METHOD(vm->dictionaryClass, Dictionary, select, 1, RETURN_TYPE(clox.std.collection.Dictionary), PARAM_TYPE_CALLABLE_N(RETURN_TYPE(Bool), 2, PARAM_TYPE(Object), PARAM_TYPE(Object)));
