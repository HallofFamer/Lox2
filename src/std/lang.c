...
void registerLangPackage(VM* vm) {
    ...
    DEF_METHOD(vm->numberClass, Number, step, 3, RETURN_TYPE(void), PARAM_TYPE(Number), PARAM_TYPE(Number), PARAM_TYPE(TCallable));
    ...
    DEF_METHOD(vm->intClass, Int, downTo, 2, RETURN_TYPE(void), PARAM_TYPE(Int), PARAM_TYPE(TCallable));
    ...
    DEF_METHOD(vm->intClass, Int, timesRepeat, 1, RETURN_TYPE(void), PARAM_TYPE(TCallable));
    ...
    DEF_METHOD(vm->intClass, Int, upTo, 2, RETURN_TYPE(void), PARAM_TYPE(Int), PARAM_TYPE(TCallable));
