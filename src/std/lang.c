...
LOX_METHOD(Type, __invoke__) {
	...
	if (IS_OBJ(value)) AS_OBJ(value)->klass = klass;
    Value initMethod;
    push(vm, value);
...
void registerLangPackage(VM* vm) {
    ...
    ObjClass* behaviorClass = getNativeClass(vm, "clox.std.lang.Behavior");
    ObjClass* objectMetaclass = getNativeClass(vm, "clox.std.lang.Object class");
    ObjClass* behaviorMetaclass = getNativeClass(vm, "clox.std.lang.Behavior class");
    ObjClass* classMetaclass = getNativeClass(vm, "clox.std.lang.Class class");
    ObjClass* metaclassMetaclass = getNativeClass(vm, "clox.std.lang.Metaclass class");
    ...
    ObjClass* stringIteratorClass = getNativeClass(vm, "clox.std.lang.StringIterator");
    ObjClass* callableTrait = getNativeClass(vm, "clox.std.lang.TCallable");

    vm->objectClass->classType = OBJ_INSTANCE;
    DEF_METHOD(vm->objectClass, Object, clone, 0, NATIVE_TYPE(Object));
    DEF_METHOD(vm->objectClass, Object, equals, 1, NATIVE_TYPE(Bool), NATIVE_TYPE(Object));
    DEF_METHOD(vm->objectClass, Object, getClass, 0, NATIVE_TYPE(Class));
    DEF_METHOD(vm->objectClass, Object, getClassName, 0, NATIVE_TYPE(String));
    DEF_METHOD(vm->objectClass, Object, getField, 1, NATIVE_TYPE(Object), NATIVE_TYPE(String));
    DEF_METHOD(vm->objectClass, Object, hasField, 1, NATIVE_TYPE(Bool), NATIVE_TYPE(String));
    DEF_METHOD(vm->objectClass, Object, hashCode, 0, NATIVE_TYPE(Int));
    DEF_METHOD(vm->objectClass, Object, instanceOf, 1, NATIVE_TYPE(Bool), NATIVE_TYPE(Behavior));
    DEF_METHOD(vm->objectClass, Object, memberOf, 1, NATIVE_TYPE(Bool), NATIVE_TYPE(Behavior));
    ...
    DEF_INTERCEPTOR(behaviorClass, Behavior, INTERCEPTOR_INIT, __init__, 0, NATIVE_TYPE(Behavior));
    DEF_METHOD(behaviorClass, Behavior, clone, 0, NATIVE_TYPE(Behavior));
    DEF_METHOD(behaviorClass, Behavior, getMethod, 1, NATIVE_TYPE(Method), NATIVE_TYPE(String));
    DEF_METHOD(behaviorClass, Behavior, hasMethod, 1, NATIVE_TYPE(Bool), NATIVE_TYPE(String));
    DEF_METHOD(behaviorClass, Behavior, isBehavior, 0, NATIVE_TYPE(Bool));
    DEF_METHOD(behaviorClass, Behavior, isClass, 0, NATIVE_TYPE(Bool));
    DEF_METHOD(behaviorClass, Behavior, isMetaclass, 0, NATIVE_TYPE(Bool));
    ...
    DEF_METHOD(vm->classClass, Class, getField, 1, NATIVE_TYPE(Object), NATIVE_TYPE(String));
    DEF_METHOD(vm->classClass, Class, hasField, 1, NATIVE_TYPE(Bool), NATIVE_TYPE(String));
    DEF_METHOD(vm->classClass, Class, instanceOf, 1, NATIVE_TYPE(Bool), NATIVE_TYPE(Behavior));
    DEF_METHOD(vm->classClass, Class, isClass, 0, NATIVE_TYPE(Bool));
    ...
    DEF_METHOD(vm->metaclassClass, Metaclass, getClassName, 0, NATIVE_TYPE(String));
    DEF_METHOD(vm->metaclassClass, Metaclass, instanceOf, 1, NATIVE_TYPE(Bool), NATIVE_TYPE(Behavior));
    DEF_METHOD(vm->metaclassClass, Metaclass, isMetaclass, 0, NATIVE_TYPE(Bool));
    DEF_METHOD(vm->metaclassClass, Metaclass, memberOf, 1, NATIVE_TYPE(Bool), NATIVE_TYPE(Behavior));
    DEF_METHOD(vm->metaclassClass, Metaclass, namedInstance, 0, NATIVE_TYPE(Class));
    DEF_METHOD(vm->metaclassClass, Metaclass, superclass, 0, NATIVE_TYPE(Class));
    DEF_METHOD(vm->metaclassClass, Metaclass, toString, 0, NATIVE_TYPE(String));
    ...
    DEF_INTERCEPTOR(vm->methodClass, Method, INTERCEPTOR_INIT, __init__, 0, NATIVE_TYPE(Method));
    ...
    DEF_METHOD(vm->methodClass, Method, arity, 0, NATIVE_TYPE(Int));
    DEF_METHOD(vm->methodClass, Method, behavior, 0, NATIVE_TYPE(Behavior));
    DEF_METHOD(vm->methodClass, Method, bind, 1, NATIVE_TYPE(BoundMethod), NATIVE_TYPE(Object));
    DEF_METHOD(vm->methodClass, Method, clone, 0, NATIVE_TYPE(Method));
    DEF_METHOD(vm->methodClass, Method, isAsync, 0, NATIVE_TYPE(Bool));
    DEF_METHOD(vm->methodClass, Method, isNative, 0, NATIVE_TYPE(Bool));
    ...
    DEF_INTERCEPTOR(vm->namespaceClass, Namespace, INTERCEPTOR_INIT, __init__, 0, NATIVE_TYPE(Namespace), NATIVE_TYPE(String), NATIVE_TYPE(Namespace));
    ...
    DEF_INTERCEPTOR(vm->traitClass, Trait, INTERCEPTOR_INIT, __init__, 2, NATIVE_TYPE(Trait), NATIVE_TYPE(String), NATIVE_TYPE(Object));
    DEF_METHOD(vm->traitClass, Trait, getClass, 0, NATIVE_TYPE(Class));
    DEF_METHOD(vm->traitClass, Trait, getClassName, 0, NATIVE_TYPE(String));
    DEF_METHOD(vm->traitClass, Trait, instanceOf, 1, NATIVE_TYPE(Bool), NATIVE_TYPE(Behavior));
    DEF_METHOD(vm->traitClass, Trait, isTrait, 0, NATIVE_TYPE(Bool));
    DEF_METHOD(vm->traitClass, Trait, memberOf, 1, NATIVE_TYPE(Bool), NATIVE_TYPE(Behavior));
    DEF_METHOD(vm->traitClass, Trait, superclass, 0, NATIVE_TYPE(Class));
    DEF_METHOD(vm->traitClass, Trait, toString, 0, NATIVE_TYPE(String));
    ...
    DEF_METHOD(vm->nilClass, Nil, clone, 0, NATIVE_TYPE(Nil));
    DEF_METHOD(vm->nilClass, Nil, objectID, 0, NATIVE_TYPE(Number));
    DEF_METHOD(vm->nilClass, Nil, toString, 0, NATIVE_TYPE(String));

    bindSuperclass(vm, vm->boolClass, vm->objectClass);
    DEF_INTERCEPTOR(vm->boolClass, Bool, INTERCEPTOR_INIT, __init__, 1, NATIVE_TYPE(Bool), NATIVE_TYPE(Bool));
    DEF_METHOD(vm->boolClass, Bool, clone, 0, NATIVE_TYPE(Bool));
    DEF_METHOD(vm->boolClass, Bool, objectID, 0, NATIVE_TYPE(Number));
    DEF_METHOD(vm->boolClass, Bool, toString, 0, NATIVE_TYPE(String));
    ...
    DEF_INTERCEPTOR(vm->numberClass, Number, INTERCEPTOR_INIT, __init__, 1, NATIVE_TYPE(Number), NATIVE_TYPE(Object));
    DEF_METHOD(vm->numberClass, Number, abs, 0, NATIVE_TYPE(Number));
    DEF_METHOD(vm->numberClass, Number, acos, 0, NATIVE_TYPE(Number));
    DEF_METHOD(vm->numberClass, Number, asin, 0, NATIVE_TYPE(Number));
    DEF_METHOD(vm->numberClass, Number, atan, 0, NATIVE_TYPE(Number));
    DEF_METHOD(vm->numberClass, Number, cbrt, 0, NATIVE_TYPE(Number));
    DEF_METHOD(vm->numberClass, Number, ceil, 0, NATIVE_TYPE(Number));
    DEF_METHOD(vm->numberClass, Number, clone, 0, NATIVE_TYPE(Number));
    DEF_METHOD(vm->numberClass, Number, compareTo, 1, NATIVE_TYPE(Int), NATIVE_TYPE(TComparable));
    DEF_METHOD(vm->numberClass, Number, cos, 0, NATIVE_TYPE(Number));
    DEF_METHOD(vm->numberClass, Number, exp, 0, NATIVE_TYPE(Number));
    DEF_METHOD(vm->numberClass, Number, floor, 0, NATIVE_TYPE(Number));
    DEF_METHOD(vm->numberClass, Number, hypot, 1, NATIVE_TYPE(Number), NATIVE_TYPE(Number));
    DEF_METHOD(vm->numberClass, Number, isInfinity, 0, NATIVE_TYPE(Bool));
    DEF_METHOD(vm->numberClass, Number, log, 0, NATIVE_TYPE(Number));
    DEF_METHOD(vm->numberClass, Number, log2, 0, NATIVE_TYPE(Number));
    DEF_METHOD(vm->numberClass, Number, log10, 0, NATIVE_TYPE(Number));
    DEF_METHOD(vm->numberClass, Number, max, 1, NATIVE_TYPE(Number), NATIVE_TYPE(Number));
    DEF_METHOD(vm->numberClass, Number, min, 1, NATIVE_TYPE(Number), NATIVE_TYPE(Number));
    DEF_METHOD(vm->numberClass, Number, objectID, 0, NATIVE_TYPE(Number));
    DEF_METHOD(vm->numberClass, Number, pow, 1, NATIVE_TYPE(Number), NATIVE_TYPE(Number));
    DEF_METHOD(vm->numberClass, Number, round, 0, NATIVE_TYPE(Number));
    DEF_METHOD(vm->numberClass, Number, sin, 0, NATIVE_TYPE(Number));
    DEF_METHOD(vm->numberClass, Number, sqrt, 0, NATIVE_TYPE(Number));
    DEF_METHOD(vm->numberClass, Number, step, 3, NATIVE_TYPE(void), NATIVE_TYPE(Number), NATIVE_TYPE(Number), NATIVE_TYPE_CALLABLE(NATIVE_TYPE(void), 1, NATIVE_TYPE(Number)));
    ...
    DEF_METHOD(vm->intClass, Int, abs, 0, NATIVE_TYPE(Int));
    DEF_METHOD(vm->intClass, Int, clone, 0, NATIVE_TYPE(Int));
    DEF_METHOD(vm->intClass, Int, downTo, 2, NATIVE_TYPE(void), NATIVE_TYPE(Int), NATIVE_TYPE_CALLABLE(NATIVE_TYPE(void), 1, NATIVE_TYPE(Int)));
    DEF_METHOD(vm->intClass, Int, factorial, 0, NATIVE_TYPE(Int));
    DEF_METHOD(vm->intClass, Int, gcd, 1, NATIVE_TYPE(Int), NATIVE_TYPE(Int));
    DEF_METHOD(vm->intClass, Int, isEven, 0, NATIVE_TYPE(Bool));
    DEF_METHOD(vm->intClass, Int, isOdd, 0, NATIVE_TYPE(Bool));
    DEF_METHOD(vm->intClass, Int, lcm, 1, NATIVE_TYPE(Int), NATIVE_TYPE(Int));
    DEF_METHOD(vm->intClass, Int, objectID, 0, NATIVE_TYPE(Number));
    DEF_METHOD(vm->intClass, Int, timesRepeat, 1, NATIVE_TYPE(void), NATIVE_TYPE_CALLABLE(NATIVE_TYPE(void), 1, NATIVE_TYPE(Int)));
    DEF_METHOD(vm->intClass, Int, toBinary, 0, NATIVE_TYPE(String));
    DEF_METHOD(vm->intClass, Int, toFloat, 0, NATIVE_TYPE(Float));
    ...
    DEF_METHOD(vm->floatClass, Float, clone, 0, NATIVE_TYPE(Float));
    DEF_METHOD(vm->floatClass, Float, toString, 0, NATIVE_TYPE(String));
    ...
    DEF_METHOD(iteratorTrait, TIterator, currentValue, 0, NATIVE_TYPE(E));
    DEF_METHOD(iteratorTrait, TIterator, moveNext, 0, NATIVE_TYPE(Bool));
    ...
    DEF_INTERCEPTOR(vm->iteratorClass, Iterator, INTERCEPTOR_INIT, __init__, 1, NATIVE_TYPE(Iterator), NATIVE_TYPE(TIterable));
    ...
    DEF_METHOD(vm->iteratorClass, Iterator, currentIndex, 0, NATIVE_TYPE(Object));
    DEF_METHOD(vm->iteratorClass, Iterator, currentValue, 0, NATIVE_TYPE(E));
    DEF_METHOD(vm->iteratorClass, Iterator, moveNext, 0, NATIVE_TYPE(Bool));
    DEF_METHOD(vm->iteratorClass, Iterator, reset, 0, NATIVE_TYPE(void));
    ...
    DEF_INTERCEPTOR(vm->stringClass, String, INTERCEPTOR_INIT, __init__, 1, NATIVE_TYPE(String), NATIVE_TYPE(String));
    DEF_FIELD(vm->stringClass, length, Int, false, INT_VAL(0));
    DEF_METHOD(vm->stringClass, String, capitalize, 0, NATIVE_TYPE(String));
    DEF_METHOD(vm->stringClass, String, clone, 0, NATIVE_TYPE(String));
    DEF_METHOD(vm->stringClass, String, contains, 1, NATIVE_TYPE(Bool), NATIVE_TYPE(String));
    DEF_METHOD(vm->stringClass, String, count, 0, NATIVE_TYPE(Int));
    DEF_METHOD(vm->stringClass, String, decapitalize, 0, NATIVE_TYPE(String));
    DEF_METHOD(vm->stringClass, String, endsWith, 1, NATIVE_TYPE(Bool), NATIVE_TYPE(String));
    DEF_METHOD(vm->stringClass, String, getByte, 1, NATIVE_TYPE(Int), NATIVE_TYPE(Int));
    DEF_METHOD(vm->stringClass, String, getCodePoint, 1, NATIVE_TYPE(String), NATIVE_TYPE(Int));
    DEF_METHOD(vm->stringClass, String, indexOf, 1, NATIVE_TYPE(Int), NATIVE_TYPE(String));
    ...
    DEF_METHOD(vm->stringClass, String, trim, 0, NATIVE_TYPE(String));
    DEF_OPERATOR(vm->stringClass, String, +, __add__, 1, NATIVE_TYPE(String), NATIVE_TYPE(String));
    DEF_OPERATOR(vm->stringClass, String, [], __getSubscript__, 1, NATIVE_TYPE(String), NATIVE_TYPE(Int));
    bindStringClass(vm);

    ObjClass* stringMetaclass = vm->stringClass->obj.klass;
    DEF_METHOD(stringMetaclass, StringClass, fromByte, 1, NATIVE_TYPE(String), NATIVE_TYPE(Object));
    DEF_METHOD(stringMetaclass, StringClass, fromCodePoint, 1, NATIVE_TYPE(String), NATIVE_TYPE(Object));

    bindSuperclass(vm, stringIteratorClass, vm->iteratorClass);
    DEF_INTERCEPTOR(stringIteratorClass, StringIterator, INTERCEPTOR_INIT, __init__, 1, NATIVE_TYPE(StringIterator), NATIVE_TYPE(Object));
    DEF_METHOD(stringIteratorClass, StringIterator, moveNext, 0, NATIVE_TYPE(Bool));

    DEF_METHOD(callableTrait, TCallable, arity, 0, NATIVE_TYPE(Int));
    DEF_METHOD(callableTrait, TCallable, isAsync, 0, NATIVE_TYPE(Bool));
    ...
    DEF_INTERCEPTOR(vm->functionClass, Function, INTERCEPTOR_INIT, __init__, 0, NATIVE_TYPE(Function));
    ...
    DEF_METHOD(vm->functionClass, Function, clone, 0, NATIVE_TYPE(Function));
    ...
    DEF_INTERCEPTOR(vm->boundMethodClass, BoundMethod, INTERCEPTOR_INIT, __init__, 2, NATIVE_TYPE(BoundMethod), NATIVE_TYPE(Object), NATIVE_TYPE(Object));
    DEF_FIELD(vm->boundMethodClass, receiver, Object, true, NIL_VAL);
    DEF_FIELD(vm->boundMethodClass, method, Method, true, NIL_VAL);
    DEF_METHOD(vm->boundMethodClass, BoundMethod, arity, 0, NATIVE_TYPE(Int));
    DEF_METHOD(vm->boundMethodClass, BoundMethod, clone, 0, NATIVE_TYPE(BoundMethod));
    DEF_METHOD(vm->boundMethodClass, BoundMethod, isAsync, 0, NATIVE_TYPE(Bool));
    DEF_METHOD(vm->boundMethodClass, BoundMethod, isNative, 0, NATIVE_TYPE(Bool));
    DEF_METHOD(vm->boundMethodClass, BoundMethod, isVariadic, 0, NATIVE_TYPE(Bool));
    DEF_METHOD(vm->boundMethodClass, BoundMethod, name, 0, NATIVE_TYPE(String));
    ...
    DEF_INTERCEPTOR(vm->generatorClass, Generator, INTERCEPTOR_INIT, __init__, 2, NATIVE_TYPE(Generator), NATIVE_TYPE(Object), NATIVE_TYPE(Object));
    DEF_METHOD(vm->generatorClass, Generator, getReceiver, 0, NATIVE_TYPE(Object));
    DEF_METHOD(vm->generatorClass, Generator, isFinished, 0, NATIVE_TYPE(Bool));
    DEF_METHOD(vm->generatorClass, Generator, isReady, 0, NATIVE_TYPE(Bool));
    DEF_METHOD(vm->generatorClass, Generator, isSuspended, 0, NATIVE_TYPE(Bool));
    DEF_METHOD(vm->generatorClass, Generator, next, 0, NATIVE_TYPE(Object));
    DEF_METHOD(vm->generatorClass, Generator, nextFinished, 0, NATIVE_TYPE(Object));
    DEF_METHOD(vm->generatorClass, Generator, returns, 1, NATIVE_TYPE(Object), NATIVE_TYPE(Object));
    DEF_METHOD(vm->generatorClass, Generator, send, 1, NATIVE_TYPE(Object), NATIVE_TYPE(Object));
    DEF_METHOD(vm->generatorClass, Generator, setReceiver, 1, NATIVE_TYPE(void), NATIVE_TYPE(Object));
    ...
    DEF_METHOD(generatorMetaclass, GeneratorClass, run, 2, NATIVE_TYPE(void), NATIVE_TYPE(TCallable), NATIVE_TYPE(Object));
    ...
    DEF_INTERCEPTOR(vm->exceptionClass, Exception, INTERCEPTOR_INIT, __init__, 1, NATIVE_TYPE(Exception), NATIVE_TYPE(String));
    DEF_METHOD(vm->exceptionClass, Exception, message, 0, NATIVE_TYPE(String));
    DEF_METHOD(vm->exceptionClass, Exception, toString, 0, NATIVE_TYPE(String));
