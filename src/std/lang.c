...
void registerLangPackage(VM* vm) {
    ...
    DEF_METHOD(vm->traitClass, Trait, memberOf, 1, RETURN_TYPE(Bool), PARAM_TYPE(Behavior));
    ...
    DEF_METHOD(vm->numberClass, Number, step, 3, RETURN_TYPE(void), PARAM_TYPE(Number), PARAM_TYPE(Number), PARAM_TYPE_CALLABLE(RETURN_TYPE(void), 1, PARAM_TYPE(Number)));
    ...
    DEF_METHOD(vm->intClass, Int, downTo, 2, RETURN_TYPE(void), PARAM_TYPE(Int), PARAM_TYPE_CALLABLE(RETURN_TYPE(void), 1, PARAM_TYPE(Int)));
    ...
    DEF_METHOD(vm->intClass, Int, timesRepeat, 1, RETURN_TYPE(void), PARAM_TYPE_CALLABLE(RETURN_TYPE(void), 1, PARAM_TYPE(Int)));
    ...
    DEF_METHOD(vm->intClass, Int, upTo, 2, RETURN_TYPE(void), PARAM_TYPE(Int), PARAM_TYPE_CALLABLE(RETURN_TYPE(void), 1, PARAM_TYPE(Int)));
