...
LOX_METHOD(File, lastAccessed) {
    ...
    if (!loadFileStat(vm, self)) {
        THROW_EXCEPTION(clox.std.io.FileNotFoundException, "Cannot get file last accessed date because it does not exist.");
    }
...
LOX_METHOD(FileClass, open) {
    ...
    if (!setFileField(vm, stream, file, mode)) THROW_EXCEPTION(clox.std.io.IOException, "Cannot open IO stream, file either does not exist or require additional permission to access."); 
...
LOX_METHOD(IOStream, file) {
    ...
    RETURN_OBJ(getFileField(vm, AS_INSTANCE(receiver), "file"));
}
...
void registerIOPackage(VM* vm) {
    ...
    DEF_INTERCEPTOR(vm->fileClass, File, INTERCEPTOR_INIT, __init__, 1, NATIVE_TYPE(clox.std.io.File), NATIVE_TYPE(String));
    DEF_METHOD(vm->fileClass, File, create, 0, NATIVE_TYPE(Bool));
    DEF_METHOD_ASYNC(vm->fileClass, File, createAsync, 0, NATIVE_TYPE_GENERIC(clox.std.util.Promise, 1, NATIVE_TYPE(Bool)));
    DEF_METHOD(vm->fileClass, File, delete, 0, NATIVE_TYPE(Bool));
    DEF_METHOD_ASYNC(vm->fileClass, File, deleteAsync, 0, NATIVE_TYPE_GENERIC(clox.std.util.Promise, 1, NATIVE_TYPE(Bool)));
    DEF_METHOD(vm->fileClass, File, exists, 0, NATIVE_TYPE(Bool));
    DEF_METHOD(vm->fileClass, File, getAbsolutePath, 0, NATIVE_TYPE(String));
    DEF_METHOD(vm->fileClass, File, isDirectory, 0, NATIVE_TYPE(Bool));
    DEF_METHOD(vm->fileClass, File, isExecutable, 0, NATIVE_TYPE(Bool));
    DEF_METHOD(vm->fileClass, File, isFile, 0, NATIVE_TYPE(Bool));
    DEF_METHOD(vm->fileClass, File, isReadable, 0, NATIVE_TYPE(Bool));
    DEF_METHOD(vm->fileClass, File, isWritable, 0, NATIVE_TYPE(Bool));
    DEF_METHOD(vm->fileClass, File, lastAccessed, 0, NATIVE_TYPE(clox.std.util.DateTime));
    DEF_METHOD(vm->fileClass, File, lastModified, 0, NATIVE_TYPE(clox.std.util.DateTime));
    DEF_METHOD(vm->fileClass, File, mkdir, 0, NATIVE_TYPE(Bool));
    DEF_METHOD_ASYNC(vm->fileClass, File, mkdirAsync, 0, NATIVE_TYPE_GENERIC(clox.std.util.Promise, 1, NATIVE_TYPE(Bool)));
    DEF_METHOD(vm->fileClass, File, name, 0, NATIVE_TYPE(String));
    DEF_METHOD(vm->fileClass, File, rename, 1, NATIVE_TYPE(Bool), NATIVE_TYPE(String));
    DEF_METHOD_ASYNC(vm->fileClass, File, renameAsync, 1, NATIVE_TYPE_GENERIC(clox.std.util.Promise, 1, NATIVE_TYPE(Bool)), NATIVE_TYPE(String));
    DEF_METHOD(vm->fileClass, File, rmdir, 0, NATIVE_TYPE(Bool));
    DEF_METHOD(vm->fileClass, File, rmdirAsync, 0, NATIVE_TYPE_GENERIC(clox.std.util.Promise, 1, NATIVE_TYPE(Bool)));
    DEF_METHOD(vm->fileClass, File, setExecutable, 1, NATIVE_TYPE(Bool), NATIVE_TYPE(Bool));
    DEF_METHOD(vm->fileClass, File, setReadable, 1, NATIVE_TYPE(Bool), NATIVE_TYPE(Bool));
    DEF_METHOD(vm->fileClass, File, setWritable, 1, NATIVE_TYPE(Bool), NATIVE_TYPE(Bool));
    DEF_METHOD(vm->fileClass, File, size, 0, NATIVE_TYPE(Number));
    DEF_METHOD(vm->fileClass, File, toString, 0, NATIVE_TYPE(String));

    ObjClass* fileMetaclass = vm->fileClass->obj.klass;
    DEF_METHOD(fileMetaclass, FileClass, open, 2, NATIVE_TYPE(IOStream), NATIVE_TYPE(String), NATIVE_TYPE(String));
    DEF_METHOD(fileMetaclass, FileClass, openAsync, 2, NATIVE_TYPE_GENERIC(clox.std.util.Promise, 1, NATIVE_TYPE(clox.std.io.IOStream)), NATIVE_TYPE(String), NATIVE_TYPE(String));
    
    DEF_METHOD(closableTrait, TClosable, close, 0, NATIVE_TYPE(Bool));
    ...
    DEF_INTERCEPTOR(ioStreamClass, IOStream, INTERCEPTOR_INIT, __init__, 1, NATIVE_TYPE(clox.std.io.IOStream), NATIVE_TYPE(Object));
    DEF_METHOD(ioStreamClass, IOStream, close, 0, NATIVE_TYPE(Bool));
    DEF_METHOD_ASYNC(ioStreamClass, IOStream, closeAsync, 0, NATIVE_TYPE_GENERIC(clox.std.util.Promise, 1, NATIVE_TYPE(Bool)));
    DEF_METHOD(ioStreamClass, IOStream, file, 0, NATIVE_TYPE(clox.std.io.File));
    DEF_METHOD(ioStreamClass, IOStream, getPosition, 0, NATIVE_TYPE(Int));
    DEF_METHOD(ioStreamClass, IOStream, reset, 0, NATIVE_TYPE(void));

    bindSuperclass(vm, readStreamClass, ioStreamClass);
    DEF_INTERCEPTOR(readStreamClass, ReadStream, INTERCEPTOR_INIT, __init__, 1, NATIVE_TYPE(clox.std.io.ReadStream), NATIVE_TYPE(Object));
    DEF_METHOD(readStreamClass, ReadStream, isAtEnd, 0, NATIVE_TYPE(Bool));
    DEF_METHOD(readStreamClass, ReadStream, read, 0, NATIVE_TYPE(Object));
    DEF_METHOD(readStreamClass, ReadStream, skip, 1, NATIVE_TYPE(Bool), NATIVE_TYPE(Int));

    bindSuperclass(vm, writeStreamClass, ioStreamClass);
    DEF_INTERCEPTOR(writeStreamClass, WriteStream, INTERCEPTOR_INIT, __init__, 1, NATIVE_TYPE(clox.std.io.WriteStream), NATIVE_TYPE(Object));
    DEF_METHOD(writeStreamClass, WriteStream, flush, 0, NATIVE_TYPE(Bool));
    DEF_METHOD_ASYNC(writeStreamClass, WriteStream, flushAsync, 0, NATIVE_TYPE_GENERIC(clox.std.util.Promise, 1, NATIVE_TYPE(Bool)));
    DEF_METHOD(writeStreamClass, WriteStream, write, 1, NATIVE_TYPE(void), NATIVE_TYPE(Object));

    bindSuperclass(vm, binaryReadStreamClass, readStreamClass);
    DEF_INTERCEPTOR(binaryReadStreamClass, BinaryReadStream, INTERCEPTOR_INIT, __init__, 1, NATIVE_TYPE(clox.std.io.BinaryReadStream), NATIVE_TYPE(Object));
    DEF_METHOD(binaryReadStreamClass, BinaryReadStream, read, 0, NATIVE_TYPE(Int));
    DEF_METHOD_ASYNC(binaryReadStreamClass, BinaryReadStream, readAsync, 0, NATIVE_TYPE_GENERIC(clox.std.util.Promise, 1, NATIVE_TYPE(Int)));
    DEF_METHOD(binaryReadStreamClass, BinaryReadStream, readBytes, 1, NATIVE_TYPE(clox.std.collection.Array), NATIVE_TYPE(Int));
    DEF_METHOD_ASYNC(binaryReadStreamClass, BinaryReadStream, readBytesAsync, 1, NATIVE_TYPE_GENERIC(clox.std.util.Promise, 1, NATIVE_TYPE(clox.std.collection.Array)), NATIVE_TYPE(Int));

    bindSuperclass(vm, binaryWriteStreamClass, writeStreamClass);
    DEF_INTERCEPTOR(binaryWriteStreamClass, BinaryWriteStream, INTERCEPTOR_INIT, __init__, 1, NATIVE_TYPE(clox.std.io.BinaryWriteStream), NATIVE_TYPE(Object));
    DEF_METHOD(binaryWriteStreamClass, BinaryWriteStream, write, 1, NATIVE_TYPE(void), NATIVE_TYPE(Int));
    DEF_METHOD_ASYNC(binaryWriteStreamClass, BinaryWriteStream, writeAsync, 1, NATIVE_TYPE_GENERIC(clox.std.util.Promise, 1, NATIVE_TYPE(Nil)), NATIVE_TYPE(Int));
    DEF_METHOD(binaryWriteStreamClass, BinaryWriteStream, writeBytes, 1, NATIVE_TYPE(void), NATIVE_TYPE(clox.std.collection.Array));
    DEF_METHOD_ASYNC(binaryWriteStreamClass, BinaryWriteStream, writeBytesAsync, 1, NATIVE_TYPE_GENERIC(clox.std.util.Promise, 1, NATIVE_TYPE(Nil)), NATIVE_TYPE(clox.std.collection.Array));

    bindSuperclass(vm, fileReadStreamClass, readStreamClass);
    DEF_INTERCEPTOR(fileReadStreamClass, FileReadStream, INTERCEPTOR_INIT, __init__, 1, NATIVE_TYPE(clox.std.io.FileReadStream), NATIVE_TYPE(Object));
    DEF_METHOD(fileReadStreamClass, FileReadStream, peek, 0, NATIVE_TYPE(String));
    DEF_METHOD(fileReadStreamClass, FileReadStream, read, 0, NATIVE_TYPE(String));
    DEF_METHOD_ASYNC(fileReadStreamClass, FileReadStream, readAsync, 0, NATIVE_TYPE_GENERIC(clox.std.util.Promise, 1, NATIVE_TYPE(String)));
    DEF_METHOD(fileReadStreamClass, FileReadStream, readLine, 0, NATIVE_TYPE(String));
    DEF_METHOD_ASYNC(fileReadStreamClass, FileReadStream, readLineAsync, 0, NATIVE_TYPE_GENERIC(clox.std.util.Promise, 1, NATIVE_TYPE(String)));
    DEF_METHOD(fileReadStreamClass, FileReadStream, readString, 0, NATIVE_TYPE(String));
    DEF_METHOD_ASYNC(fileReadStreamClass, FileReadStream, readStringAsync, 0, NATIVE_TYPE_GENERIC(clox.std.util.Promise, 1, NATIVE_TYPE(String)));
    DEF_METHOD(fileReadStreamClass, FileReadStream, readToEnd, 0, NATIVE_TYPE(String));
    DEF_METHOD_ASYNC(fileReadStreamClass, FileReadStream, readToEndAsync, 0, NATIVE_TYPE_GENERIC(clox.std.util.Promise, 1, NATIVE_TYPE(String)));

    bindSuperclass(vm, fileWriteStreamClass, writeStreamClass);
    DEF_INTERCEPTOR(fileWriteStreamClass, FileWriteStream, INTERCEPTOR_INIT, __init__, 1, NATIVE_TYPE(clox.std.io.FileWriteStream), NATIVE_TYPE(Object));
    DEF_METHOD(fileWriteStreamClass, FileWriteStream, write, 1, NATIVE_TYPE(void), NATIVE_TYPE(String));
    DEF_METHOD_ASYNC(fileWriteStreamClass, FileWriteStream, writeAsync, 1, NATIVE_TYPE_GENERIC(clox.std.util.Promise, 1, NATIVE_TYPE(Nil)), NATIVE_TYPE(String));
    DEF_METHOD(fileWriteStreamClass, FileWriteStream, writeLine, 0, NATIVE_TYPE(void));
    DEF_METHOD_ASYNC(fileWriteStreamClass, FileWriteStream, writeLineAsync, 0, NATIVE_TYPE_GENERIC(clox.std.util.Promise, 1, NATIVE_TYPE(Nil)));
    DEF_METHOD(fileWriteStreamClass, FileWriteStream, writeSpace, 0, NATIVE_TYPE(void));
    DEF_METHOD_ASYNC(fileWriteStreamClass, FileWriteStream, writeSpaceAsync, 0, NATIVE_TYPE_GENERIC(clox.std.util.Promise, 1, NATIVE_TYPE(Nil)));
    DEF_METHOD(fileWriteStreamClass, FileWriteStream, writeString, 1, NATIVE_TYPE(void), NATIVE_TYPE(String));
    DEF_METHOD_ASYNC(fileWriteStreamClass, FileWriteStream, writeStringAsync, 1, NATIVE_TYPE_GENERIC(clox.std.util.Promise, 1, NATIVE_TYPE(Nil)), NATIVE_TYPE(String));
