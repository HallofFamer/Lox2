    ...
    switch (object->category) {
        ...
        case OBJ_MODULE: {
            ...
            return sizeof(ObjModule) + sizeof(Value) * module->valFields.capacity + sizeof(IDEntry) * module->valIndexes.capacity
                ...
                + sizeof(Value) * module->typeNames.capacity + sizeof(Value) * module->dependencies.capacity;
        }
        case OBJ_NAMESPACE: {
...
static void blackenObject(VM* vm, Obj* object, GCGenerationType generation) {
    ...
    switch (object->category) {
        ...
        case OBJ_MODULE: {
            ...
            markArray(vm, &module->typeNames, generation);
...
static void freeObject(VM* vm, Obj* object) {
    ...
    switch (object->category) {
        ...
        case OBJ_MODULE: {
			...
			freeValueArray(vm, &module->typeNames);
