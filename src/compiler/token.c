...
const char* tokenNames[] = {
    ...
    [TOKEN_SYMBOL_AND]            = "TOKEN_SYMBOL_AND",
    [TOKEN_SYMBOL_AS]             = "TOKEN_SYMBOL_AS",
    [TOKEN_SYMBOL_ASYNC]          = "TOKEN_SYMBOL_ASYNC",
    [TOKEN_SYMBOL_AWAIT]          = "TOKEN_SYMBOL_AWAIT",
    [TOKEN_SYMBOL_BREAK]          = "TOKEN_SYMBOL_BREAK",
    [TOKEN_SYMBOL_CASE]           = "TOKEN_SYMBOL_CASE",
    [TOKEN_SYMBOL_CATCH]          = "TOKEN_SYMBOL_CATCH",
    [TOKEN_SYMBOL_CLASS]          = "TOKEN_SYMBOL_CLASS",
    [TOKEN_SYMBOL_CONTINUE]       = "TOKEN_SYMBOL_CONTINUE",
    [TOKEN_SYMBOL_DEFAULT]        = "TOKEN_SYMBOL_DEFAULT",
    [TOKEN_SYMBOL_ELSE]           = "TOKEN_SYMBOL_ELSE",
    [TOKEN_SYMBOL_EXTENDS]        = "TOKEN_SYMBOL_EXTENDS",
    [TOKEN_SYMBOL_FALSE]          = "TOKEN_SYMBOL_FALSE",
    [TOKEN_SYMBOL_FINALLY]        = "TOKEN_SYMBOL_FINALLY",
    [TOKEN_SYMBOL_FOR]            = "TOKEN_SYMBOL_FOR",
    [TOKEN_SYMBOL_FROM]           = "TOKEN_SYMBOL_FROM",
    [TOKEN_SYMBOL_FUN]            = "TOKEN_SYMBOL_FUN",
    [TOKEN_SYMBOL_IF]             = "TOKEN_SYMBOL_IF",
    [TOKEN_SYMBOL_NAMESPACE]      = "TOKEN_SYMBOL_NAMESPACE",
    [TOKEN_SYMBOL_NIL]            = "TOKEN_SYMBOL_NIL",
    [TOKEN_SYMBOL_OR]             = "TOKEN_SYMBOL_OR",
    [TOKEN_SYMBOL_REQUIRE]        = "TOKEN_SYMBOL_REQUIRE",
    [TOKEN_SYMBOL_RETURN]         = "TOKEN_SYMBOL_RETURN",
    [TOKEN_SYMBOL_SUPER]          = "TOKEN_SYMBOL_SUPER",
    [TOKEN_SYMBOL_SWITCH]         = "TOKEN_SYMBOL_SWITCH",
    [TOKEN_SYMBOL_THIS]           = "TOKEN_SYMBOL_THIS",
    [TOKEN_SYMBOL_THROW]          = "TOKEN_SYMBOL_THROW",
    [TOKEN_SYMBOL_TRAIT]          = "TOKEN_SYMBOL_TRAIT",
    [TOKEN_SYMBOL_TRUE]           = "TOKEN_SYMBOL_TRUE",
    [TOKEN_SYMBOL_TRY]            = "TOKEN_SYMBOL_TRY",
    [TOKEN_SYMBOL_TYPE]          = "TOKEN_TYPE",
    [TOKEN_SYMBOL_USING]          = "TOKEN_SYMBOL_USING",
    [TOKEN_SYMBOL_VAL]            = "TOKEN_SYMBOL_VAL",
    [TOKEN_SYMBOL_VAR]            = "TOKEN_SYMBOL_VAR", 
    [TOKEN_SYMBOL_VOID]           = "TOKEN_SYMBOL_VOID",
    [TOKEN_SYMBOL_WHILE]          = "TOKEN_SYMBOL_WHILE",
    [TOKEN_SYMBOL_WITH]           = "TOKEN_SYMBOL_WITH",
    [TOKEN_SYMBOL_YIELD]          = "TOKEN_SYMBOL_YIELD",
