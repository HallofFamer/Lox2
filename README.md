...
```
git clone -b v2.1.3 https://github.com/HallofFamer/Lox2.git
cd Lox2
...
docker run -w /Lox2-2.1.3/Lox2 -i -t lox2:linux
```

Note: It is recommended to clone from the latest stable release branch("v2.1.3" at this moment), as the master branch receives updates regularly and some changes may break existing code. 
